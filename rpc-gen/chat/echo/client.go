...
type Client interface {
	Chat(ctx context.Context, Req *chat.ChatReq, callOptions ...callopt.Option) (stream Echo_ChatClient, err error)
}

// StreamClient is designed to provide Interface for Streaming APIs.
type StreamClient interface {
	Chat(ctx context.Context, Req *chat.ChatReq, callOptions ...streamcall.Option) (stream Echo_ChatClient, err error)
}

type Echo_ChatClient interface {
	streaming.Stream
	Recv() (*chat.ChatResp, error)
}
...
func (p *kEchoClient) Chat(ctx context.Context, Req *chat.ChatReq, callOptions ...callopt.Option) (stream Echo_ChatClient, err error) {
...
func (p *kEchoStreamClient) Chat(ctx context.Context, Req *chat.ChatReq, callOptions ...streamcall.Option) (stream Echo_ChatClient, err error) {
